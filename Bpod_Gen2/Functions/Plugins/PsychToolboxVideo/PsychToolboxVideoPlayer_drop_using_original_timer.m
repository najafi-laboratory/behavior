...
classdef PsychToolboxVideoPlayer < handle
    ...
    properties (Access = private)
        ...
        tic1 % start time marker
        toc1 % stop time marker
    end
    methods
        function obj = PsychToolboxVideoPlayer(MonitorID, ViewPortSize, ViewPortOffset, SyncPatchSize, SyncPatchYOffset)
            ...
            obj.Timer = timer('TimerFcn','','Period', round(obj.ifi,3), 'ExecutionMode', 'fixedRate', 'Tag', 'PTV');
        ...
        function playNextFrame(obj, e) 
            ...
            % mark time after sending frame to graphics pipeline
