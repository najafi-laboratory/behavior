...
% Resize image.png or generate a simple sinusoidal grating if no image exists.
if isfile(imagePath)
...
grating = gray + contrast / 2 .* sin(2 * pi * spatialFreq * (cosd(orientation) * x + sind(orientation) * y) + phase);
