function rate_discrimination_opto_V2_1
        ...
        switch S.GUI.TrainingLevel
            ...
            case 2 % Mid 1 Trained
                if (currentTrial <= S.GUI.NumNaiveWarmup)
                    ...
                    StateMidTrain1(sma, S, SCOA, TrialTarget, VisStim.Data.VisStimDuration, DURA);
                end
            case 3 % Mid 2 Trained
                if (currentTrial <= S.GUI.NumNaiveWarmup)
                    ...
                    StateMidTrain2(sma, S, SCOA, TrialTarget, VisStim.Data.VisStimDuration, DURA);
                end
            case 4 % well trained
                if (currentTrial <= S.GUI.NumNaiveWarmup)
                    ExperimenterTrialInfo.TrainingLevel = 'Naive warmup';
