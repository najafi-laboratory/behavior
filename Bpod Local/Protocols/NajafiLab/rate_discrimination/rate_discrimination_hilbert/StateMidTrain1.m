function StateMidTrain1(S, SCOA, TrialTarget, CenterValveTime, VisStimDuration, TimeOutPunish, ITI)
    ...
    sma = AddState(sma, 'Name', 'Punish', ...
        ...
        'StateChangeConditions', {'Tup', 'ChangingMindWindow'},...
        'OutputActions', SCOA.Punish);

    sma = AddState(sma, 'Name', 'ChangingMindWindow', ...
        'Timer', S.GUI.ChangeMindDur,...
        'StateChangeConditions', {TrialTarget.CorrectLick, 'ChangingMindReward', 'Tup', 'TimeOutPunish'},...
        'OutputActions', {});
