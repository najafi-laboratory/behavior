...
AudioStimSound = GenerateSineWave(SF, S.GUI.AudioStimFreq_Hz, 15); % Sampling freq (hz), Sine frequency (hz), duration (s)
...
for currentTrial = 1:MaxTrials
    ...
    OutputActionAudioVisStim = {'SoftCode', 5, 'HiFi1', ['P' 3], 'BNCState', 1};
...
%'Timer', ValveTime,...
   ...
   %'Timer', S.GUI.WindowRewardGrabDuration_Naive_s,...
    ...
    sma = AddState(sma, 'Name', 'PunishSetup', ...
        ...
        'OutputActions', {}); % Set white noise waveform
