...
for currentTrial = 1:MaxTrials
    ...
    sma = AddState(sma, 'Name', 'CenterLick', ...
        ...
        'StateChangeConditions', {'Tup', 'DidNotLickCenter', 'Port2In', 'CenterReward', 'Port1In', 'EarlyChoice_1', 'Port3In', 'EarlyChoice_1'},...
        'OutputActions', {}); 
