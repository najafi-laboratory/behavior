...
[OptoTrialTypes] = GenOptoTrials(BpodSystem, S);
...
BpodSystem.setStatusLED(1);
    ...
    disp('Enabling Bpod Status LEDs...');
    BpodSystem.setStatusLED(1); % enable Bpod status LEDs after session
    disp('Resetting maestro object...');
    clear global M;
    disp('Resetting Video Player object...');
    BpodSystem.PluginObjects.V = [];

    % add some stuff here for recording protocol errors for statistical
