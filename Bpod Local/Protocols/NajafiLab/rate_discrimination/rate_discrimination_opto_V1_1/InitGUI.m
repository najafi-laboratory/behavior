...
function [S] = SetParams(obj, BpodSystem)
    ...
    if isempty(fieldnames(S))
        ...
        S.GUI.ITIMax = 5;
        S.GUI.ITIMean = 3;
        S.GUI.ActTimeOutPunish = 0; % S.GUI.ActTimeOutPunish = 1;
        ...
        S.GUI.NumNaiveWarmup = 0; % S.GUI.NumNaiveWarmup = 15;
        ...
        S.GUI.PreVisStimDelay_s = 0.0221;
        ...
        % choice params
        S.GUI.ChoiseWindowStartDelay = 0.3;
