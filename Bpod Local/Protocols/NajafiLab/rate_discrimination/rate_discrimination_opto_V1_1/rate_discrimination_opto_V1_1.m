function rate_discrimination_opto_V1_1
    ...
    for currentTrial = 1:S.GUI.MaxTrials
        ...
        % VisStimDuration = VisStim.Data.Pre.Dur + VisStim.Data.Post.Dur + VisStim.Data.Extra.Dur;
        ...
        if m_Opto.EnableOpto
            SCOA.SpoutIn = [SCOA.SpoutIn, {'GlobalTimerCancel', '101'}];
        end
        ...
        sma = m_Opto.InsertGlobalTimer(sma, S, VisStimDuration);
