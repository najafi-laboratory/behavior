...
function [S] = SetParams(obj, BpodSystem)
    ...
    if isempty(fieldnames(S))
        ...
        S.GUI.PreVisStimDelay_s = 0.200;
        S.GUI.PostVisStimDelay_s = 0.100;
        S.GUI.PreGoCueDelay_s = 0;
        S.GUI.EasyMax = 1;
        S.GUIMeta.EasyMax.Style = 'popupmenu';
        S.GUIMeta.EasyMax.String = {'Default', 'Activated', 'Deactivated'};
        S.GUIPanels.VisStim = {'VisStimEnable', 'RandomOrient', 'PostPertDur', 'ExtraStim', 'PostPertDurExtra', 'GratingDur_s', 'ISIShortMin_s', 'ISIShortMean_s', 'ISIShortMax_s', 'ISILongMin_s', 'ISILongMean_s', 'ISILongMax_s', 'PrePertFlashRep', 'PreRewardDelay', 'PostRewardDelay', 'PostPunishDelay', 'PostOutcomeDelay', 'MinISIPerturb_ms', 'PreVisStimDelay_s', 'PreGoCueDelay_s', 'EasyMax'}; 
