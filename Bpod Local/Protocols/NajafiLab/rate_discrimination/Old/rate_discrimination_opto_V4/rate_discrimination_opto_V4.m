function rate_discrimination_opto_V4
    ...
    TrialTypeOutcomePlot(BpodSystem.GUIHandles.OutcomePlot, 'init', TrialTypes, OptoType);
    BpodParameterGUI('init', S); % Initialize parameter GUI plugin

     %% add update for change of opto trial options?
    currentTrial = 1;
    % [OptoType] = m_Opto.UpdateOptoTrials(BpodSystem, S, OptoType, currentTrial, 1);
    % m_Plotter.UpdateOutcomePlot(BpodSystem, TrialTypes, 0);
   

    m_Plotter.UpdateOutcomePlot(BpodSystem, TrialTypes, OptoType, 0);
    ...
    for currentTrial = 1:S.GUI.MaxTrials
        ...
        %% opto
        % [OptoType] = m_Opto.UpdateOptoTrials(BpodSystem, S, OptoType, currentTrial, 0);
        ...
        if ~isempty(fieldnames(RawEvents))
            ...
            m_Plotter.UpdateOutcomePlot(BpodSystem, TrialTypes, OptoType, 1);
            StateTiming();
            SaveBpodSessionData;
        end
