...
function [S] = SetParams(obj, BpodSystem)
    ...
    if isempty(fieldnames(S))
        ...
        S.GUIMeta.ManualTrialType.String = {'Opto Off', 'Opto On'};
        S.GUI.TrialTypeSequence = 3;
        S.GUIMeta.TrialTypeSequence.Style = 'popupmenu';
        S.GUIMeta.TrialTypeSequence.String = {'Random', 'Random First Block', 'Off First Block', 'On First Block'};
        S.GUI.OnFraction = 0.3;
        S.GUI.NumTrialsPerBlock = 50;  
        S.GUIPanels.Opto = {'EnableManualTrialType', 'ManualTrialType', 'TrialTypeSequence', 'OnFraction', 'NumTrialsPerBlock'};
