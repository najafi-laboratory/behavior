...
function [trial_outcome] = GetOutcome( ...
    ...
    elseif ( isfield(trial_states, 'EarlyChoice') && ...
            ~isnan(trial_states.EarlyChoice(1)))
        trial_outcome = 'EarlyChoice';
    elseif ( isfield(trial_states, 'DidNotChoose') && ...
            ~isnan(trial_states.DidNotChoose(1)))
        trial_outcome = 'DidNotChoose';
    elseif ( isfield(trial_states, 'HabituationInitReward') && ...
            ~isnan(trial_states.HabituationInitReward(1)))
        trial_outcome = 'Habituation';
    else
