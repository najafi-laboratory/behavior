function StateNaive(S, SCOA, TrialTarget, CenterValveTime, VisStimDuration, TimeOutPunish, ITI)
    ...
    sma = AddState(sma, 'Name', 'WindowChoice', ...
        ...
        'StateChangeConditions', {'Tup', 'DidNotChoose', TrialTarget.CorrectLick, 'PostRewardDelay', 'Condition1', 'PostRewardDelay', TrialTarget.IncorrectLick, 'PunishSetup', 'Condition2', 'PunishSetup'},...
        'OutputActions', {});
