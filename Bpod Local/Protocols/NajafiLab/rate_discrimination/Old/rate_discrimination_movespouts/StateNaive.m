function StateNaive(S, CorrectPort, IncorrectPort, CorrectLick, IncorrectLick, OutputActionArgInitCue, ...
    CenterValveTime, visStim, VisStimDuration, audStim, OutputActionsPreGoCueDelay, ...
    ...
    sma = AddState(sma, 'Name', 'PunishSetup', ...
        ...
        'OutputActions', OutputActionsPunishSetup);
