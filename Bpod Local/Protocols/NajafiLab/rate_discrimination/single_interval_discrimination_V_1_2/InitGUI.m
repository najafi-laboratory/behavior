...
function [S] = SetParams(obj, BpodSystem)
    ...
    if isempty(fieldnames(S))
        ...
        S.GUIPanels.Servos = {'EnableMovingSpouts', 'RightServoInPos', 'LeftServoInPos', 'ServoDeflection', 'AntiBiasServoAdjustAct', 'ServoBiasIncrement', 'ServoIncrementMax', 'ResetServoAdjust'};
