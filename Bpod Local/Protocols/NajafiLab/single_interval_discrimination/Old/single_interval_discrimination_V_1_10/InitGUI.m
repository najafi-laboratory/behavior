...
function [S] = SetParams(obj, BpodSystem)
    ...
    if isempty(fieldnames(S))
        ...
        S.GUIPanels.Opto = {'OptoSession', 'OptoSide', 'LEDOnPulseDur', 'OnFraction', 'OptoFreq', 'EnDoricOpto'};
        ...
        S.GUI.ISILongMean_s = 1.100;
        S.GUI.ISILongMin_s = 0.900;
        S.GUI.ISILongMax_s = 1.300;
        S.GUI.ISIOrig_s = 0.750;        
        % S.GUI.ISIOrig_s = 2;
