...
switch Action
    case 'init'
        ...
        BpodSystem.GUIHandles.CorrectRejectLine = line([0,0],[0,0], 'LineStyle','none','Marker','o','MarkerEdge',[0, 0.5, 0],'MarkerFace', [0, 0.5, 0], 'MarkerSize',6);
    ...
    case 'update'
        ...
        if ~isempty(OutcomeRecord)
            ...
            % correct reject
            CorrectRejectTrialsIndx = (OutcomeRecord(indxToPlot) == 8);
            Xdata = indxToPlot(CorrectRejectTrialsIndx); Ydata = TrialTypeList(Xdata);
            DispData = Xdata-offset;
            set(BpodSystem.GUIHandles.CorrectRejectLine, 'xdata', [DispData,DispData], 'ydata', [Ydata,Ydata]);            
