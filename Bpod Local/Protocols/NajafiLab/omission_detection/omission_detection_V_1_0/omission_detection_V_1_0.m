function omission_detection_V_1_0
try
    ...
    protocol_version = 'omission_detection_V_1_0';
    ...
    for currentTrial = 1:S.GUI.MaxTrials
        ...
        CenterValveAmount_uL = S.GUI.CenterValveAmount_uL;
        CenterValveAmount_uL = 10;
        ...
        CenterValveTime = m_TrialConfig.Amount2Time(CenterValveAmount_uL, 2);
        ...
        [OddballISI] = m_TrialConfig.GetOddballISI( ...
                S, TrialDifficulty, PerturbInterval, TrialTypes, currentTrial);

        [OmissIdx] = m_TrialConfig.GetOmissIdx(S);
        BpodSystem.Data.TrialVars.Trial{currentTrial}.OmissIdx = OmissIdx;
        ...
        VisStim = m_AVstimConfig.GetVideoDataPost(S, BpodSystem, FPS, VisStim, GrayPerturbISI, JitterFlag, OmissIdx, OddballISI);
        ...
        S, VisStim, SF, Envelope, BpodSystem, OmissIdx);
        H.load(5, FullAudio);
        ...
        % 
        % TargetConfig.Omission.CorrectChoice = 'Lick';
        % TargetConfig.Omission.CorrectLick   = 'Port2In';
        % TargetConfig.Omission.Port   = 'Port2';
        % TargetConfig.Omission.IncorrectLick = 'Tup';
        % TargetConfig.Omission.Valve         = 'Valve2';
        % TargetConfig.Omission.ValveTime     = CenterValveTime;
        % 
        % TargetConfig.Standard.CorrectChoice = 'No Lick';
        % TargetConfig.Standard.CorrectLick   = 'Tup';
        % TargetConfig.Standard.Port   = 'Port2';
        % TargetConfig.Standard.IncorrectLick = 'Port2In';
        % TargetConfig.Standard.Valve         = 'Valve2';
        % TargetConfig.Standard.ValveTime     = CenterValveTime;     

        TargetConfig.Omission.CorrectChoice = 'Lick';
        TargetConfig.Omission.Hit   = 'Port2In';
        TargetConfig.Omission.Port   = 'Port2';
        TargetConfig.Omission.Miss = 'Tup';
        TargetConfig.Omission.Valve         = 'Valve2';
        TargetConfig.Omission.ValveTime     = CenterValveTime;

        TargetConfig.Standard.CorrectChoice = 'No Lick';
        TargetConfig.Standard.CorrectRejection   = 'Tup';
        TargetConfig.Standard.Port   = 'Port2';
        TargetConfig.Standard.FalseAlarm = 'Port2In';
        TargetConfig.Standard.Valve         = 'Valve2';
        TargetConfig.Standard.ValveTime     = 0;         

        switch TrialTypes(currentTrial)
            case 1
                TrialTarget = TargetConfig.Omission;
            case 2
                TrialTarget = TargetConfig.Standard;
        end
        ...
        switch S.GUI.TrainingLevel
            case 1 % naive
                ...
                StateNaive(sma, BpodSystem, S, SCOA, TrialTarget, VisStim.Data.VisStimDuration, DURA, currentTrial);
            ...
            case 2 % early Trained
                if (currentTrial <= S.GUI.NumNaiveWarmup)
                    ...
                    StateEarlyTrain(sma, BpodSystem, S, SCOA, TrialTarget, VisStim.Data.VisStimDuration, DURA, currentTrial);
                end                
        ...
        ExperimenterTrialInfo.CenterValveAmount = CenterValveAmount_uL;
        ...
        if ~isempty(fieldnames(RawEvents))
            ...
            BpodSystem.Data.TrialTypes(currentTrial) = TrialTypes(currentTrial);
            BpodSystem.Data.ProbeTrials(currentTrial) = ProbeTrials(currentTrial);
