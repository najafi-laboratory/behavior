...
function [S] = SetParams(obj, BpodSystem)
    ...
    if isempty(fieldnames(S))
        ...
        S.GUI.OnFraction = 0.25;
        S.GUI.OptoFreq = 0.1;
        S.GUI.EarliestOpto = 20;
        S.GUI.EnDoricOpto = 1;
        S.GUIMeta.EnDoricOpto.Style = 'checkbox';
        S.GUIPanels.Opto = {'OptoSession', 'OptoSide', 'OptoRegion', 'LEDOnPulseDur', 'OnFraction', 'OptoFreq', 'EarliestOpto', 'EnDoricOpto'};
        ...
        % Doric API
        S.GUI.EnDoricAPI = 1;
        S.GUIMeta.EnDoricAPI.Style = 'checkbox';

        S.GUI.DoricSequence = 2;
        S.GUIMeta.DoricSequence.Style = 'popupmenu';
        S.GUIMeta.DoricSequence.String = {'Pulse_RampDown', 'Continuous_RampDown', 'RampUp_Pulse', 'RampUp_Continuous'};                       
        
        S.GUI.ContinuousCurrent = 20;
        S.GUI.ContinuousTimeOnMs = 1000;

        S.GUI.PulseCurrent = 20;
        S.GUI.PulseNbOfSeq = 1;
        S.GUI.PulseNbOfPulsesPerSeq = 100;
        S.GUI.PulsePeriodMs = 30;
        S.GUI.PulseTimeOnMs = 5;

        S.GUI.RampDownCurrent = 20;
        S.GUI.RampDownNbOfSeq = 1;
        S.GUI.RampDownNbOfPulsesPerSeq = 1;
        S.GUI.RampDownPeriodMs = 200;
        S.GUI.RampDownTimeOnMs = 200;

        S.GUI.RampUpCurrent = 20;
        S.GUI.RampUpNbOfSeq = 1;
        S.GUI.RampUpNbOfPulsesPerSeq = 1;
        S.GUI.RampUpPeriodMs = 2000;
        S.GUI.RampUpTimeOnMs = 2000;
        
        S.GUIPanels.OptoDoric = {'EnDoricAPI', 'DoricSequence', 'ContinuousCurrent', 'ContinuousTimeOnMs', 'PulseCurrent', 'PulseNbOfSeq', 'PulseNbOfPulsesPerSeq', 'PulsePeriodMs', 'PulseTimeOnMs', 'RampDownCurrent', 'RampDownNbOfSeq', 'RampDownNbOfPulsesPerSeq', 'RampDownPeriodMs', 'RampDownTimeOnMs', 'RampUpCurrent', 'RampUpNbOfSeq', 'RampUpNbOfPulsesPerSeq', 'RampUpPeriodMs', 'RampUpTimeOnMs'};        
