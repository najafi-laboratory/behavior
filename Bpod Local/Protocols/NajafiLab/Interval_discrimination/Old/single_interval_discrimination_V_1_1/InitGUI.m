...
function [S] = SetParams(obj, BpodSystem)
    ...
    if isempty(fieldnames(S))
        ...
        switch BpodSystem.Data.RigName
            ...
            case '2AFCRig2'
                S.GUI.RightServoInPos = 1154.00;
                S.GUI.LeftServoInPos = 1910.00;
        ...
        S.GUI.ProbeWaterTrialsAct = 1;
        S.GUIMeta.ProbeWaterTrialsAct.Style = 'checkbox';
        S.GUI.NumProbeWaterTrials = 10;
        S.GUI.ProbeSpoutSelectTrialsAct = 1;
        S.GUIMeta.ProbeSpoutSelectTrialsAct.Style = 'checkbox';        
        S.GUI.NumProbeSpoutSelectTrials = 3; 
        S.GUIPanels.Contingency_Bias = {'ShortISIFraction', 'RepeatedIncorrect', 'RepeatedProb', 'AdjustValve', 'NumMonitorTrials', 'BiasIndexThres', 'AdjustValvePercent', 'AdjustFraction', 'ManualSideAct', 'ManualSide', 'ProbeWaterTrialsAct', 'NumProbeWaterTrials', 'ProbeSpoutSelectTrialsAct', 'NumProbeSpoutSelectTrials'};
