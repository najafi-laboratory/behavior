function single_interval_discrimination_V_1_1
try
    ...
    for currentTrial = 1:S.GUI.MaxTrials
        ...
        [AntiBiasVar, LeftValveAmount_uL, RightValveAmount_uL] = m_TrialConfig.AntiBiasProbeTrialsWater( ...
            BpodSystem, S, AntiBiasVar, currentTrial, TrialTypes, LeftValveAmount_uL, RightValveAmount_uL);

        [AntiBiasVar] = m_TrialConfig.AntiBiasProbeTrialsSpoutSelect( ...
            BpodSystem, S, AntiBiasVar, currentTrial);        
        
        BpodSystem.Data.IsProbeWaterTrial(currentTrial) = AntiBiasVar.IsProbeWaterTrial;
        BpodSystem.Data.IsProbeSpoutSelectTrial(currentTrial) = AntiBiasVar.IsProbeSpoutSelectTrial;
        ...
        BpodSystem.Data.LeftValveAmount_uL(currentTrial) = LeftValveAmount_uL;
        BpodSystem.Data.RightValveAmount_uL(currentTrial) = RightValveAmount_uL;
