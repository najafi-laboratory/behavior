...
function [S] = SetParams(obj, BpodSystem)
    ...
    if isempty(fieldnames(S))
        ...
        % block params
        S.GUI.NumBlockWarmup = 2;
        S.GUI.NumBlockType = 2;
        S.GUI.BlockSidePrior = 0.8;
        S.GUI.BlockLength = 25;
        S.GUI.BlockMargin = 3;
        S.GUI.NumBlockChangeTrial = 4;
        S.GUI.StartBlockType = 0;
        S.GUIPanels.BlockConfig = {'NumBlockWarmup', 'NumBlockType', 'BlockSidePrior', 'BlockLength', 'BlockMargin', 'NumBlockChangeTrial', 'StartBlockType'};
        ...
        % Optogentic params
        S.GUI.OptoSession = 1;
        S.GUIMeta.OptoSession.Style = 'popupmenu';
        S.GUIMeta.OptoSession.String = {'none', 'random', 'alternate early', 'all early'};
        S.GUI.OptoSide = 1;
        S.GUIMeta.OptoSide.Style = 'popupmenu';
        S.GUIMeta.OptoSide.String = {'Left', 'Right'};  
        S.GUI.OptoRegion = 1;
        S.GUIMeta.OptoRegion.Style = 'popupmenu';
        S.GUIMeta.OptoRegion.String = {'RLat', 'LLat', 'RIntA', 'LIntA', 'LPPC', 'RPPC', 'mPFC', 'LPost', 'RPost'};
        S.GUI.LEDOnPulseDur = 0.078;
        S.GUI.EnableOptoType1 = 1;
        S.GUIMeta.EnableOptoType1.Style = 'checkbox';
        S.GUI.EnableOptoType2 = 0;
        S.GUIMeta.EnableOptoType2.Style = 'checkbox';
        S.GUI.OnFraction = 0.15;
        S.GUI.OptoFreq = 0.1;
        S.GUI.EarliestOpto = 20;
        S.GUI.OptoEarlyNumTrial = 10;
        S.GUI.OptoEarlyProb = 1.0;
        S.GUIPanels.Opto = {'OptoSession', 'OptoSide', 'OptoRegion', 'LEDOnPulseDur', 'EnableOptoType1', 'EnableOptoType2', 'OnFraction', 'OptoFreq', 'EarliestOpto', 'OptoEarlyNumTrial', 'OptoEarlyProb'};
        ...
        switch BpodSystem.Data.RigName
            case 'ImagingRig'
                S.GUI.RightServoInPos = 1184.00;
                S.GUI.LeftServoInPos = 1706.00; 
                
                % S.GUI.RightServoInPos = 1178.00;
                % S.GUI.LeftServoInPos = 1711.00;  

                % S.GUI.RightServoInPos = 1234.00;
                % S.GUI.LeftServoInPos = 1694.00;
            case '2AFCRig2'
                S.GUI.RightServoInPos = 1124.25;  % close
                S.GUI.LeftServoInPos = 1916.75;   % close
        ...
        S.GUI.ISILongMean_s = 2.100;
        S.GUI.ISILongMin_s = 1.900;
        S.GUI.ISILongMax_s = 2.300;
        S.GUI.ISIOrig_s = 1.250;        
        % S.GUI.ISIOrig_s = 2;
        ...
        S.GUI.PreRewardDelay = 0.200;
        S.GUI.PostRewardDelay = 1.500;
        ...
        S.GUI.PostVisStimDelayMin_s = 0.200;
        ...
        S.GUI.AntiBiasProbeAct = 0;
        S.GUIMeta.AntiBiasProbeAct.Style = 'checkbox';     
        S.GUI.AutoSingleSpout = 0;
        ...
        S.GUI.ManualSpoutMove = 1;
        S.GUIMeta.ManualSpoutMove.Style = 'popupmenu';
        S.GUIMeta.ManualSpoutMove.String = {'Neutral', 'Leftward', 'Rightward'};
        S.GUIPanels.Contingency_Bias = {'ShortISIFraction', 'RepeatedIncorrect', 'RepeatedProb', 'AdjustValve', 'NumMonitorTrials', 'BiasIndexThres', 'AdjustValvePercent', 'AdjustFractionAct', 'AdjustFraction', 'ManualSideAct', 'ManualSide', 'AntiBiasProbeAct', 'AutoSingleSpout', 'ProbeWaterDistribution', 'ManualSingleSpoutAct', 'ManualSpoutMove'};
        ...
        S.GUI.LeftValveAmount_uL = 6;
        S.GUI.RightValveAmount_uL = 6;
    ...
    if ~isfield(S.GUI, 'EnableOptoType1')
        S.GUI.EnableOptoType1 = 1;
    end
    S.GUIMeta.EnableOptoType1.Style = 'checkbox';
    if ~isfield(S.GUI, 'EnableOptoType2')
        S.GUI.EnableOptoType2 = 0;
    end
    S.GUIMeta.EnableOptoType2.Style = 'checkbox';
    S.GUIPanels.Opto = {'OptoSession', 'OptoSide', 'OptoRegion', 'LEDOnPulseDur', 'EnableOptoType1', 'EnableOptoType2', 'OnFraction', 'OptoFreq', 'EarliestOpto', 'OptoEarlyNumTrial', 'OptoEarlyProb'};
