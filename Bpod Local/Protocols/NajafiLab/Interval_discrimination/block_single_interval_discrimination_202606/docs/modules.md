...
Creates the initial intended opto schedule as a `7 x nTrials` matrix for stimulus, spout-in delay, spout-in, pre-outcome, reward, post-reward, and punish-ITI periods.
