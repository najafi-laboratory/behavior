...
try
    ...
    % % Check the selected sleep deprivation condition
    % switch S.GUI.SleepDeprived
    %     case 1
    %         disp('Pre_EBC_SD: SD was done right before EBD');
    %     case 2
    %         disp('Control_(No_SD)');
    %     case 3
    %         disp('Post_EBC_SD: SD was done right after EBD');
    % 
    % end
    ...
    for currentTrial = 1:MaxTrials        
        ...
        switch S.GUI.SleepDeprived
            ...
            case 3
                disp(['Trial',num2str(currentTrial),': Post_EBC SD enabled, SD was done right after EBD']);
