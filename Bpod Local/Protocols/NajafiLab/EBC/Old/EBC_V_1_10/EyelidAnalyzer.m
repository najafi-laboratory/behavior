classdef EyelidAnalyzer < handle
    ...
    methods
        ...
        function createGUI(obj)
            ...
            obj.tAdjustThresh = uicontrol('Style', 'text', 'Position', [0.5 0.5 120 20], 'String', 'Adjust Threshold:');
            obj.tMinThresh = uicontrol('Style', 'text', 'Position', [20 30 200 20], 'String', 'Baseline_Fraction_Eye_Open Threshold:');
            ...
            obj.bselectROI = uicontrol('Style', 'pushbutton', 'String', 'Select ROI', 'Units', 'normalized',...
                'Position', [0.25, 0.5, 0.15, 0.05], 'Callback', @obj.selectROI);
