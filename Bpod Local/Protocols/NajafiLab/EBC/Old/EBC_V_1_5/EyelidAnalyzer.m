classdef EyelidAnalyzer < handle
    ...
    methods
        ...
        function connectVideoTrial(obj, ~, ~)            
            ...
            % 'hardware'     'risingEdge'        'externalTriggerMode0-Source2'
            ...
            %isrunning(obj.vid)
            %strobe
            %https://www.mathworks.com/help/imaq/accessing-devices-and-video-sources.html
            %obj.startVideoTrial
