...
try
    ...
    probeIndices = {};
        ...
        switch S.GUI.TrainingStage
            ...
            case 2  % Well-trained
                S.GUI.TrialTypeSequence = 3;  % doubleBlock_longFirst
                S.GUI.BlockType = 2;          % long
                % probetrials_percentage_perBlock = 15;  % or whatever default you set
        end
    ...
    for currentTrial = 1:MaxTrials        
        ...
        if isWarmupPhase
           ...
           switch S.GUI.TrialTypeSequence
            ...
            if S.GUI.TrainingStage == 2 && any(currentTrialInBlock == probeTrialsThisBlock)
        ...
        if ~isempty(fieldnames(RawEvents)) % If trial data was returned (i.e. if not final trial, interrupted by user)
            ...
            switch S.GUI.SleepDeprived
                ...
                case 2
                    sessionTypeStr = 'Post_EBC SD (Control) enabled, SD will be done right after EBD';
                case 3
                    sessionTypeStr = 'SD+1 --> First SD session enabled, immediately following Post_EBC SD session';
                case 4
