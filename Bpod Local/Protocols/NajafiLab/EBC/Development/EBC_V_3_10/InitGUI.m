...
function [S] = SetParams(obj, BpodSystem)
    ...
    if isempty(fieldnames(S))  % If settings file was an empty struct, populate struct with default settings
        ...
        S.GUIPanels.EBC = {'ITI_Pre', 'ITI_Post', 'ITI_Extra', 'LED_OnsetDelay', 'LED_Dur', 'TrialTypeSequence', 'AirPuff_OnsetDelay', 'AirPuff_OnsetDelay_Short', 'AirPuff_OnsetDelay_Long', 'AirPuff_Dur', 'CheckEyeOpenAveragingBaseline', 'CheckEyeOpenTimeout'};
