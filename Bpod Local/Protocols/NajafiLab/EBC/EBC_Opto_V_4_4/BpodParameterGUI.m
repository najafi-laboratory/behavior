...
switch Op
    case 'init'
        ...
        for p = 1:nPanels
            ...
            uipanel('title', PanelNames{p},'FontSize', 8, 'FontWeight', 'Bold', 'BackgroundColor','white','Units','Pixels', 'Position',[HPos VPos 400 ThisPanelHeight]);
            % InPanelPos = 10;
            InPanelPos = 8;
            for i = 1:nParams
                ...
                switch lower(ThisParamStyle)
                    case 'edit'
                        ...
                        BpodSystem.GUIHandles.ParameterGUI.Params(ParamNum) = uicontrol('Style', 'edit', 'String', num2str(ThisParam), 'Position', [HPos+200 VPos+InPanelPos+2 150 25], 'FontWeight', 'normal', 'FontSize', 8, 'BackgroundColor','white', 'FontName', 'Arial','HorizontalAlignment','Center');
                    case 'text'
                        ...
                        BpodSystem.GUIHandles.ParameterGUI.Params(ParamNum) = uicontrol('Style', 'text', 'String', num2str(ThisParam), 'Position', [HPos+200 VPos+InPanelPos+2 150 25], 'FontWeight', 'normal', 'FontSize', 8, 'BackgroundColor','white', 'FontName', 'Arial','HorizontalAlignment','Center');
                    case 'checkbox'
                        ...
                        BpodSystem.GUIHandles.ParameterGUI.Params(ParamNum) = uicontrol('Style', 'checkbox', 'Value', ThisParam, 'String', '   (check to activate)', 'Position', [HPos+200 VPos+InPanelPos+4 150 25], 'FontWeight', 'normal', 'FontSize', 8, 'BackgroundColor','white', 'FontName', 'Arial','HorizontalAlignment','Center');
                    case 'popupmenu'
                        ...
                        BpodSystem.GUIHandles.ParameterGUI.Params(ParamNum) = uicontrol('Style', 'popupmenu', 'String', ThisParamString, 'Value', ThisParam, 'Position', [HPos+200 VPos+InPanelPos+2 150 25], 'FontWeight', 'normal', 'FontSize', 8, 'BackgroundColor','white', 'FontName', 'Arial','HorizontalAlignment','Center');
                    case 'pushbutton'
                        ...
                        BpodSystem.GUIHandles.ParameterGUI.Params(ParamNum) = uicontrol('Style', 'pushbutton', 'String', ThisParamName, 'Position', [HPos+200 VPos+InPanelPos+2 150 25], 'FontWeight', 'normal', 'FontSize', 8, 'BackgroundColor','white', 'FontName', 'Arial','HorizontalAlignment','Center', 'Callback', ThisParam);
                    otherwise
