...
try
    ...
    protocol_version = 'single_interval_discrimination_V_1_11';
    ...
    [TrialTypes, BlockTypes] = m_TrialConfig.GenTrials(S);
    [TrialTypes] = m_TrialConfig.AdjustWarmupTrials(S, TrialTypes);
    [ProbeTrials] = m_TrialConfig.GenProbeTrials(S);
    [OptoType]    = m_Opto.GenOptoType(S, BlockTypes);

    % if BpodSystem.Data.RigName ~= 'ImagingRig'
    if EnLaser
        % init Doric laser
    ...
    for currentTrial = 1:S.GUI.MaxTrials
        ...
        % OptoDuration = VisStim.Data.VisStimDuration;
