...
function [S] = SetParams(obj, BpodSystem)
    ...
    if isempty(fieldnames(S))
        ...
        S.GUI.LEDOnPulseDur = 0.025;
        S.GUI.OnFraction = 0.20;
        S.GUI.OptoFreq = 0.1;
        S.GUI.EarliestOpto = 20;
        S.GUI.OptoEarlyNumTrial = 10;
        S.GUI.OptoEarlyProb = 0.7;
        S.GUIPanels.Opto = {'OptoSession', 'OptoSide', 'OptoRegion', 'LEDOnPulseDur', 'OnFraction', 'OptoFreq', 'EarliestOpto', 'OptoEarlyNumTrial', 'OptoEarlyProb'};
