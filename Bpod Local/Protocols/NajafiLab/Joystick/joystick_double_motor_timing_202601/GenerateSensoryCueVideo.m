function [cueVideo, grayVideo, duration] = GenerateSensoryCueVideo(imagePath, width, height, fps, requestedDuration, useGeneratedGrating)
% Resize image.png or generate the visual component of the sensory cue.
if nargin < 6
...
if useGeneratedGrating
    ...
    if ~isfile(imagePath)
        error('Sensory cue image not found: %s', imagePath)
    end
