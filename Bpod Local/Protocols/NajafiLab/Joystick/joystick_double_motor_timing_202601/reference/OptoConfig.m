classdef OptoConfig
   properties
    ...
    methods   
        ...
        function [OptoTrialTypes, BpodSystem] = GenOptoTrials(~, BpodSystem, S)
        ...
        function [OptoTrialTypes, BpodSystem] = UpdateOptoTrials(obj, BpodSystem, S, OptoTrialTypes, TrialTypes, currentTrial, forceUpdate)
