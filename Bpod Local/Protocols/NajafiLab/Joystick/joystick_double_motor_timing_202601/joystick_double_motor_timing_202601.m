...
items = {
    ...
    S.GUI.ManualITI_s ~= defaultS.GUI.ManualITI_s, '%-28s %.3f s\n', {'Manual ITI:', S.GUI.ManualITI_s};
    ...
    S.GUI.ManualPunishITI_s ~= defaultS.GUI.ManualPunishITI_s, '%-28s %.3f s\n', {'Manual punish ITI:', S.GUI.ManualPunishITI_s};
