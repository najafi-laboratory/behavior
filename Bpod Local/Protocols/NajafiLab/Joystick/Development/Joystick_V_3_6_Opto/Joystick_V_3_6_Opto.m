...
%         end    
        ...
        sma = AddState(sma, 'Name', 'PostRewardDelay', ...
            ...
            'StateChangeConditions', PostRewardDelay_StateChangeConditions,...		% {'Tup', 'LeverRetract2'}
            'OutputActions', {});        
        ...
        sma = AddState(sma, 'Name', 'LeverRetract2', ...
            'Timer', 0,...
            'StateChangeConditions', LeverRetract2_StateChangeConditions,...	% {'SoftCode1', 'ITI'} % Softcode1: Indicate to the state machine that the lever is back in the home position
