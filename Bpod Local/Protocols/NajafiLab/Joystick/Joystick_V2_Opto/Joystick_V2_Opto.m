...
try
    ...
    for currentTrial = 1:MaxTrials
        ...
        % audStimOpto = {'HiFi1', ['P', 6], 'BNC1', 1};        
        % SCOA.AudStim     = m_Opto.GetAudStimOpto(OptoTrialTypes(currentTrial));

        audStimOpto = {'HiFi1', ['P', 6]};
        audStimOpto = m_Opto.GetAudStimOpto(OptoTrialTypes(currentTrial));
        ...
        VisualStimulus1_OutputActions = audStimOpto;        
        ...
        VisualStimulus2_OutputActions = [audStimOpto 'SoftCode', 7,'RotaryEncoder1', ['E']];
