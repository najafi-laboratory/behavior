...
%BpodSystem.PluginObjects.S.holdRMScurrent = 200; % find nearest detent and hold, use as zero pos
pause(0.2);
BpodSystem.PluginObjects.R.setPosition(0); % Set the current position to equal 0
BpodSystem.PluginObjects.S.holdRMScurrent = 0; % release holding current
...
for currentTrial = 1:MaxTrials
    ...
    %         VideoStartToGoCueDur_NumAudioSamples = floor(SF * VideoStartToGoCueDur_s);
    ...
    %InitWindow_StateChangeConditions = {'Tup', 'InitCueAgain', 'Port2In', 'VisDetect1'};
    %InitWindow_StateChangeConditions = {'Tup', 'InitCueAgain', 'Port2In', 'VisualStimulus1'};

    SetLeverBeforePress_StateChangeConditions = {'Tup', 'VisDetect1'}; 
   % SetLeverBeforePress_StateChangeConditions = {'SoftCode1', 'VisDetect1'}; 

    VisDetect1_StateChangeConditions = {'Tup', 'VisStimInterrupt', 'BNC1High', 'VisualStimulus1'};
    %VisDetect1_StateChangeConditions = {'Tup', 'VisualStimulus1'};   
    ...
    Reward1Time = CenterValveTime;
    Reward2Time = CenterValveTime;
    Reward3Time = CenterValveTime;
    ...
    switch S.GUI.Reps
        ...
        case 3
            ...
            Reward2_StateChangeConditions = {'Tup', 'PostReward2Delay'};
            LeverRetract2_StateChangeConditions = {'SoftCode1', 'VisDetect3'};
            WaitForPress3_StateChangeConditions = {'Tup', 'DidNotPress3', 'RotaryEncoder1_1', 'Reward3'};
    ...
    disp(['reps = ' num2str(S.GUI.Reps)]);
    disp(['Reward1Time = ' num2str(Reward1Time)]);
    disp(['Reward2Time = ' num2str(Reward2Time)]);
    disp(['Reward3Time = ' num2str(Reward3Time)]);
...
%% rep 1
    ...
    sma = AddState(sma, 'Name', 'WaitForPress1', ...
        ...
        'OutputActions', {'Stepper1', ['i' HoldingCurrent 0], 'SoftCode', 12,'RotaryEncoder1', ['E'], 'PWM1', 255}); % ['i' 0 0] turns off the stepper holding current. 
...
%% rep 3
    ...
    sma = AddState(sma, 'Name', 'WaitForPress3', ...
        ...
        'OutputActions', {'SoftCode', 12, 'RotaryEncoder1', 'E', 'PWM1', 255}); % Port1 LED turns on to indicate that the lever is ready to press
    %'OutputActions', {'Stepper1', ['i' 0 0], 'RotaryEncoder1', 'E', 'PWM1', 255}); % Port1 LED turns on to indicate that the lever is ready to press
