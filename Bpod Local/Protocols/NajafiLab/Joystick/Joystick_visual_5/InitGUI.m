...
function [S] = SetParams(obj, BpodSystem)
    ...
    if isempty(fieldnames(S))  % If settings file was an empty struct, populate struct with default settings
        ...
        S.GUI.PressWindow_s = 10.0; % how long mouse has to press lever
        S.GUI.Reps = 1.0;   % number of required repeated lever presses in a trial
        S.GUI.ZeroRTrials = 1;
        ...
        S.GUI.ServoInPos = 1527.00; % lever start pos
        S.GUI.ServoOutPos = 24; % can press lever
        S.GUIPanels.Joystick = {'Threshold', 'PressWindow_s', 'Reps', 'ZeroRTrials', 'ResistanceLevel', 'PostRewardDelay_s', 'ServoInPos', 'ServoOutPos'};                
