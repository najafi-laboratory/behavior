...
for currentTrial = 1:MaxTrials
    ...
    switch S.GUI.TrainingLevel
        ...
        case 1 % Habituation        
            VisualStimulusStateChangeConditions = {'Tup', 'RewardDelay'}; %% defaulted
            ExperimenterTrialInfo.TrainingLevel = 'Habituation';
            S.GUI.Reps = 1;
            
        case 2 % naive        
            VisualStimulusStateChangeConditions = {'Tup', 'RewardDelay'};
            ExperimenterTrialInfo.TrainingLevel = 'Naive';
            S.GUI.Reps = 1;
    
        case 3 % Mid 1 Trained
            VisualStimulusStateChangeConditions = {'Tup', 'GreyScreen'};  %% defaulted
    ...
    InitWindow_StateChangeConditions = {'Tup', 'InitCueAgain', 'Port2In', 'WaitForPress1'};
    VisStimTrigger1_StateChangeConditions = {'Tup', 'VisualStimulus1'};   

    WaitForPress1_StateChangeConditions = {'Tup', 'VisualStimulus1', 'RotaryEncoder1_1', 'LeverRetract1'};
   
    VisStimTrigger2_StateChangeConditions = {'Tup', 'VisualStimulus2'}; 
    
    WaitForPress2_StateChangeConditions = {'Tup', 'VisStimTriggerPunish', 'RotaryEncoder1_1', 'LeverRetract2'};


    CenterReward_StateChangeConditions = {'Tup', 'ITI'};
    CenterReward_OutputActions = {'Valve2', 1, 'SoftCode', 8};
    ...
    LeverRetract3_StateChangeConditions = {};
     ...
     %% Overridden defaults in training matrix
    switch S.GUI.Reps
        case 1
            VisualStimulusStateChangeConditions = {'Tup', 'RewardDelay'};
        case 2
            VisualStimulusStateChangeConditions = {'Tup', 'GreyScreen'};
    end
...
%% rep 1
    ...
    sma = AddState(sma, 'Name', 'LeverRetract1', ...
        'Timer', 0,...
        'StateChangeConditions', {'SoftCode1', 'VisStimTrigger1'},... % When the PC is done resetting the lever, it sends soft code 1 to the state machine
    ...
    sma = AddState(sma, 'Name', 'GreyScreen', ...
        'Timer', S.GUI.GreyScreenLength_s,...
        'StateChangeConditions', {'Tup', 'WaitForPress2'},...
        'OutputActions', {});

%% rep 2
    sma = AddState(sma, 'Name', 'WaitForPress2', ...
        'Timer', S.GUI.PressWindow_s2,...
        'StateChangeConditions', VisStimTriggerPunish,...
    ...
    sma = AddState(sma, 'Name', 'LeverRetract2', ...
        'Timer', 0,...
        'StateChangeConditions', {'SoftCode1', 'VisStimTrigger2'},...
...
%% reps complete
    ...
    sma = AddState(sma, 'Name', 'VisStimTriggerPunish', ...
        'Timer', S.GUI.GratingDur_s,...
        'StateChangeConditions', {'Tup', 'VisualStimulusPunish'},...
        'OutputActions', visStim);

    sma = AddState(sma, 'Name', 'VisualStimulusPunish', ...
        'Timer', S.GUI.OutcomeDelayDur_S,...
    ...
    if ~isempty(fieldnames(RawEvents)) % If trial data was returned (i.e. if not final trial, interrupted by user)
        ...
        LastTrialEncoderPlot(BpodSystem.GUIHandles.EncoderAxes, 'update', S.GUI.Threshold, BpodSystem.Data.EncoderData{currentTrial},TrialDuration);
