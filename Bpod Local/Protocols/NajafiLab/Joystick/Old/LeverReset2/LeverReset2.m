...
for currentTrial = 1:MaxTrials
    ...
    sma = AddState(sma, 'Name', 'WaitForPress1', ...
        ...
        'OutputActions', {'Stepper1', ['i' 0 0], 'RotaryEncoder1', ['E#' 0], 'PWM1', 255, 'Valve2' , 1}); % ['i' 0 0] turns off the stepper holding current. 
    ...
    sma = AddState(sma, 'Name', 'LeverRetract1', ...
        ...
        'OutputActions', {'SoftCode', 1, 'Valve2' , 0}); % On entering the LeverRetract state, send soft code 1 to the PC. The soft code handler will then start resetting the lever.
