...
switch Action
    case 'init'
        ...
        BpodSystem.GUIHandles.LatePressLine = line([0,0],[0,0], 'LineStyle','none','Marker','o','MarkerEdge','y','MarkerFace', 'y', 'MarkerSize',6);
    ...
    case 'update'
        ...
        if ~isempty(OutcomeRecord)
            ...
            % late press
            LatePressTrialsIndx = (OutcomeRecord(indxToPlot) == 6);
            Xdata = indxToPlot(LatePressTrialsIndx); Ydata = TrialTypeList(Xdata);
            DispData = Xdata-offset;
            set(BpodSystem.GUIHandles.LatePressLine, 'xdata', [DispData,DispData], 'ydata', [Ydata,Ydata]);
