...
function [S] = SetParams(obj, BpodSystem)
    ...
    if isempty(fieldnames(S))  % If settings file was an empty struct, populate struct with default settings
        ...
        S.GUI.PressInterval_s = 1.8; % how long mouse has to press lever
        S.GUI.PressIntervalExtend_s = 1; % additional time added for warmup trials
        ...
        S.GUI.ServoInPos = 1565.00; % lever start pos
        ...
        S.GUIPanels.Joystick = {'Threshold', 'PressInterval_s', 'Reps', 'ZeroRTrials', 'ResistanceLevel', 'PostRewardDelay_s', 'ServoInPos', 'ServoOutPos', 'Reward_Rep', 'CenterValveAmount_uL', 'CenterValveAmountRep_percent', 'VisStim2Enable', 'PressVisDelayShort_s', 'PressVisDelayLong_s', 'EarlyPressThreshold', 'EnableManualTrialType', 'ManualTrialType', 'TrialTypeSequence', 'NumTrialsPerBlock'};                
        ...
        S.GUIPanels.ITI_Dist = {'SetManualITI', 'ForceITIZero', 'ITIMin', 'ITIMax', 'ITIMean', 'ActTimeOutPunish', 'TimeOutPunish'};
        ...
        S.GUI.IntervalRewardGrabDuration_Naive_s = 10;  % naive mouse has up to x seconds to grab reward    
        ...
        S.GUIPanels.Reward = {'LeftValveTime_s', 'RightValveTime_s', 'IntervalRewardGrabDuration_Naive_s', 'RewardDelay_s', 'WindCenterLick_s'};
        ...
        % choice params
        S.GUI.ChoiceInterval_s = 5; % How long after go cue until the mouse must make a choice
        S.GUI.ConfirmLickInterval_s = 0.2; % min interval until choice can be confirmed    
        S.GUI.ChoiceConfirmInterval_s = 5; % time during which correct choice can be confirmed    
        S.GUIPanels.Choice = {'ChoiceInterval_s', 'ConfirmLickInterval_s', 'ChoiceConfirmInterval_s'};
