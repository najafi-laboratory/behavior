...
for currentTrial = 1:MaxTrials
    ...
    CenterReward_OutputActions = {'Valve2', 1, 'SoftCode', 10};
    ...
    LeverReset_StateChangeConditions = {'SoftCode1', 'ITI'};

    switch S.GUI.Reps
        case 1
            LeverRetract1_StateChangeConditions = {'SoftCode1', 'Reward'};
        case 2
            LeverRetract1_StateChangeConditions = {'SoftCode1', 'VisStimTrigger2'};
    ...
    sma = AddState(sma, 'Name', 'Start', ...
        ...
        'OutputActions', {'HiFi1','*', 'RotaryEncoder1', ['#' 0]}); % Code to push newly uploaded waves to front (playback) buffers
                                                                      % ['#' 0] sends byte 0x0 to the rotary encoder module for                                                                       
                                                                      %         a trial start timestamp on its clock     
    
%     sma = AddState(sma, 'Name', 'LeverSet', ...
%         'Timer', 0,...
%         'StateChangeConditions', LeverReset_StateChangeConditions,...
%         'OutputActions', {});   
...
%% rep 1
    ...
    sma = AddState(sma, 'Name', 'WaitForPress1', ...
        ...
        'OutputActions', {'Stepper1', ['i' 0 0], 'RotaryEncoder1', 'E', 'PWM1', 255}); % ['i' 0 0] turns off the stepper holding current. 
...
%% reps complete
    ...
    sma = AddState(sma, 'Name', 'DidNotPress1', ...
        'Timer', 0,...
        'StateChangeConditions', {'Tup', 'LeverReset'},...
        'OutputActions', {});
    ...
    sma = AddState(sma, 'Name', 'LeverReset', ...
        'Timer', 0,...
        'StateChangeConditions', LeverReset_StateChangeConditions,...
        'OutputActions', {'SoftCode', 8}); 
