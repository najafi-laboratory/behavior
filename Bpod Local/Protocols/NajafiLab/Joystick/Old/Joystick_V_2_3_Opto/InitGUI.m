...
function [S] = SetParams(obj, BpodSystem)
    ...
    if isempty(fieldnames(S))  % If settings file was an empty struct, populate struct with default settings
        ...
        S.GUIMeta.PulseType.String = {'On', 'Square', 'Pulsed'};
        ...
        S.GUIPanels.Opto = {'SessionType', 'PulseType', 'MaxOptoDur','SquareFreq_Hz', 'SquareOnDur_ms', 'LEDOnPulseDur', 'OptoFreq', 'OptoVis1', 'OptoWaitForPress1', 'OptoVis2', 'OptoWaitForPress2', 'OptoTrialTypeSeq', 'OnFraction', 'NumOptoTrialsPerBlock'};
