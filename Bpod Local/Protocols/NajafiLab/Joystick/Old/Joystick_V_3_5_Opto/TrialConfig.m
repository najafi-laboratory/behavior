    ...
    elseif updateTrialTypeSequence
        ...
        switch S.GUI.TrialTypeSequence
            ...
            case 2 % interleaved - random first trial type                
                ...
                while numTrialsAddedToSequence < MaxTrials
                    TrialTypesToAdd = [TrialTypesToAdd repmat(FirstTrialType, 1, NumTrialsPerBlock(NumTrialsPerBlockIdx)) repmat(SecondTrialType, 1, NumTrialsPerBlock(NumTrialsPerBlockIdx + 1))];
                    numTrialsAddedToSequence = numTrialsAddedToSequence + NumTrialsPerBlock(NumTrialsPerBlockIdx) + NumTrialsPerBlock(NumTrialsPerBlockIdx + 1);
            ...
            case 3 % interleaved - short first block, rcrsfty3rd
                ...
                while numTrialsAddedToSequence < MaxTrials
                    TrialTypesToAdd = [TrialTypesToAdd repmat(1, 1, NumTrialsPerBlock(NumTrialsPerBlockIdx)) repmat(2, 1, NumTrialsPerBlock(NumTrialsPerBlockIdx + 1))];
                    numTrialsAddedToSequence = numTrialsAddedToSequence + NumTrialsPerBlock(NumTrialsPerBlockIdx) + NumTrialsPerBlock(NumTrialsPerBlockIdx + 1);
                    NumTrialsPerBlockIdx = NumTrialsPerBlockIdx + 2;
                end
                TrialTypes(currentTrial:end) = TrialTypesToAdd(1:length(TrialTypes) - currentTrial + 1);             
            case 4 % interleaved - long first block
                ...
                while numTrialsAddedToSequence < MaxTrials
                    TrialTypesToAdd = [TrialTypesToAdd repmat(2, 1, NumTrialsPerBlock(NumTrialsPerBlockIdx)) repmat(1, 1, NumTrialsPerBlock(NumTrialsPerBlockIdx + 1))];
                    numTrialsAddedToSequence = numTrialsAddedToSequence + NumTrialsPerBlock(NumTrialsPerBlockIdx) + NumTrialsPerBlock(NumTrialsPerBlockIdx + 1);
                    NumTrialsPerBlockIdx = NumTrialsPerBlockIdx + 2;
                end
                TrialTypes(currentTrial:end) = TrialTypesToAdd(1:length(TrialTypes) - currentTrial + 1);
