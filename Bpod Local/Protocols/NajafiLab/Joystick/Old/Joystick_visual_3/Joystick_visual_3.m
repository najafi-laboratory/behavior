...
for currentTrial = 1:MaxTrials
    ...
    switch S.GUI.TrainingLevel
        case 1 % Habituation        
            ...
            AuToPress_StateChangeConditions = {'SoftCode1', 'Reward'};
            ExperimenterTrialInfo.TrainingLevel = 'Habituation';
        case 2 % naive        
...
%% rep 1
    ...
    sma = AddState(sma, 'Name', 'AuToPress', ...
        ...
        'OutputActions', {'RotaryEncoder1', ['E#' 0], 'SoftCode', 9});

    sma = AddState(sma, 'Name', 'WaitForPress1', ...
        'Timer', S.GUI.PressWindow_s,...
        'StateChangeConditions', WaitForPress1_StateChangeConditions,...
        'OutputActions', {'RotaryEncoder1', ['E#' 0], 'PWM1', 255}); % ['i' 0 0] turns off the stepper holding current. 
