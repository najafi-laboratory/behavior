...
switch Op
    case 'init'
        ...
        for p = 1:nPanels
            ...
            uipanel('title', PanelNames{p},'FontSize', 7, 'FontWeight', 'Bold', 'BackgroundColor','white','Units','Pixels', 'Position',[HPos VPos 370 ThisPanelHeight]);
            % InPanelPos = 10;
            % InPanelPos = 8;
            InPanelPos = 6;
            for i = 1:nParams
                ...
                BpodSystem.GUIHandles.ParameterGUI.Labels(ParamNum) = uicontrol('Style', 'text', 'String', ThisParamName, 'Position', [HPos+5 VPos+InPanelPos 170 25], 'FontWeight', 'normal', 'FontSize', 7, 'BackgroundColor','white', 'FontName', 'Arial','HorizontalAlignment','Center');
                switch lower(ThisParamStyle)
                    ...
                    case 'checkbox'
                        ...
                        BpodSystem.GUIHandles.ParameterGUI.Params(ParamNum) = uicontrol('Style', 'checkbox', 'Value', ThisParam, 'String', '   (check to activate)', 'Position', [HPos+200 VPos+InPanelPos+4 130 25], 'FontWeight', 'normal', 'FontSize', 7, 'BackgroundColor','white', 'FontName', 'Arial','HorizontalAlignment','Center');
                    case 'popupmenu'
                        ...
                        BpodSystem.GUIHandles.ParameterGUI.Params(ParamNum) = uicontrol('Style', 'popupmenu', 'String', ThisParamString, 'Value', ThisParam, 'Position', [HPos+200 VPos+InPanelPos+2 130 25], 'FontWeight', 'normal', 'FontSize', 7, 'BackgroundColor','white', 'FontName', 'Arial','HorizontalAlignment','Center');
                    case 'pushbutton'
                        ...
                        BpodSystem.GUIHandles.ParameterGUI.Params(ParamNum) = uicontrol('Style', 'pushbutton', 'String', ThisParamName, 'Position', [HPos+200 VPos+InPanelPos+2 130 25], 'FontWeight', 'normal', 'FontSize', 7, 'BackgroundColor','white', 'FontName', 'Arial','HorizontalAlignment','Center', 'Callback', ThisParam);
                    otherwise
