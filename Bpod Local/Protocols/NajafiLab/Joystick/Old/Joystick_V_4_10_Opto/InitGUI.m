...
function [S] = SetParams(obj, BpodSystem)
    ...
    if isempty(fieldnames(S))  % If settings file was an empty struct, populate struct with default settings
        ...
        S.GUI.Press2WindowShort_s = 0.5; % how long mouse has to press lever 
        ...
        switch BpodSystem.Data.RigName
            case 'ImagingRig'
                S.GUI.ServoInPos = 1823.00; % lever start pos
                % S.GUI.ServoInPos = 1810.00; % lever start pos
                S.GUI.ServoOutPos = 34; % can press leverc
            case 'JoystickRig1'
                S.GUI.ServoInPos = 1638.00; % lever start pos
                S.GUI.ServoOutPos = 38; % can press lever
            case 'JoystickRig2'
                S.GUI.ServoInPos = 1528.00; % lever start pos
        ...
        S.GUI.PrePress2DelayShort_s = 0.300;
        ...
        S.GUI.CenterValveAmount_uL = 3.5;
