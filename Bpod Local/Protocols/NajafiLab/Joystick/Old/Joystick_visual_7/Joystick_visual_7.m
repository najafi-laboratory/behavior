...
try
    ...
    % get uniform distribution of trial types
    numTrialTypes = 1;
    ...
    %% rep 1
        ...
        sma = AddState(sma, 'Name', 'WaitForPress1', ...
            ...
            'OutputActions', {'SoftCode', 7,'RotaryEncoder1', ['E']}); % ['i' 0 0] turns off the stepper holding current. 
