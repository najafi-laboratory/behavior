...
function UpdateOutcomePlot(obj, BpodSystem, TrialTypes, OptoTrialTypes, isEndOfTrial)
    ...
    if isfield(Data, 'nTrials')
        ...
        TrialTypeOutcomePlot(BpodSystem.GUIHandles.OutcomePlot,'update', Data.nTrials+1, TrialTypes, OptoTrialTypes, Outcomes);
    else
        Outcomes = zeros(1, 1);
        TrialTypeOutcomePlot(BpodSystem.GUIHandles.OutcomePlot,'update', 1, TrialTypes, OptoTrialTypes, Outcomes);
        yticks([1 2])
