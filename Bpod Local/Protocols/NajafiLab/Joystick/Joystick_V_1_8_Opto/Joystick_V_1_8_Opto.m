...
try
    ...
    for currentTrial = 1:MaxTrials
        ...
        VideoOptoDelay = [GrayFrame_SyncW GrayFrame_SyncBlk GrayFrame_SyncBlk]; % 60 fps, F1, F2, F3

        VideoOptoDelayDur = (length(VideoOptoDelay) - 1) * (1/FramesPerSecond); % for audio sync, subtract variable start frame 
    
        FullOptoVideo = [VideoOptoDelay GratingVideo];
        ...
        VisDetectVariable1OutputAction = {'RotaryEncoder1', ['E']};
        VisDetectVariable2OutputAction = {'RotaryEncoder1', ['E']};
        ...
        VisDetect1_StateChangeConditions = {'Tup', 'VisStimInterrupt', 'BNC1High', 'VisDetectVariable1', 'RotaryEncoder1_2', 'EarlyPress1'};
        VisDetectVariable1_StateChangeConditions = {'Tup', 'VisStimInterrupt', 'BNC1High', 'VisualStimulus1', 'RotaryEncoder1_2', 'EarlyPress1'};
        ...
        VisDetect2_StateChangeConditions = {'Tup', 'VisStimInterrupt', 'BNC1High', 'VisDetectVariable2', 'RotaryEncoder1_2', 'EarlyPress2'};
        VisDetectVariable2_StateChangeConditions = {'Tup', 'VisStimInterrupt', 'BNC1High', 'VisualStimulus2', 'RotaryEncoder1_2', 'EarlyPress2'};
        ...
        if m_Opto.EnableOpto && (OptoTrialTypes(currentTrial) == 2)
            if S.GUI.OptoVis1
                VisDetectVariable1OutputAction = [VisDetectVariable1OutputAction , {'GlobalTimerTrig', '000010001'}];
            end
            
            if S.GUI.OptoVis2
                VisDetectVariable2OutputAction = [VisDetectVariable2OutputAction , {'GlobalTimerTrig', '001000100'}];
            end            
        ...
        sma = AddState(sma, 'Name', 'VisDetectVariable1', ...
            'Timer', 0.100,...
            'StateChangeConditions', VisDetectVariable1_StateChangeConditions,...
            'OutputActions', VisDetectVariable1OutputAction);        
        ...
        sma = AddState(sma, 'Name', 'VisDetectVariable2', ...
            'Timer', 0.100,...
            'StateChangeConditions', VisDetectVariable2_StateChangeConditions,...
            'OutputActions', VisDetectVariable2OutputAction);          
