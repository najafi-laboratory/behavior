...
% wait for parameter update and confirm before beginning trial loop
    ...
    for currentTrial = 1:MaxTrials
        ...
        %% video for probe trials
        % FullGrayVideo = ProbeGrayVideo;
        % FullVideoFrames = length(FullGrayVideo);
        % VisStim.VisStimDuration = GratingDur;
        % ExperimenterTrialInfo.VisStimDuration = VisStim.VisStimDuration;     

        %% video for opto joystick stim, gray frames for shutter open delay
        % VideoOptoDelay = [GrayFrame_SyncW GrayFrame_SyncBlk GrayFrame_SyncBlk]; % 60 fps, F1, F2
        ...
        % VisStim.VisStimOptoDuration = (FullOptoVideoFrames - 1) * (1/FramesPerSecond); % subtract variable start frame
        % ExperimenterTrialInfo.VisStimOptoDuration = VisStim.VisStimOptoDuration;      
            ...
            switch (TrialTypes(currentTrial-1))
                case 1
                    if (S.GUI.PrePress2DelayLong_s >= 0.100)
                        ...
                        % disp(['min(S.GUI.PrePress2DelayLong_s + S.GUI.AutoDelayStep_s, S.GUI.AutoDelayMaxLong_s): ' num2str(min(S.GUI.PrePress2DelayLong_s + S.GUI.AutoDelayStep_s, S.GUI.AutoDelayMaxLong_s))])
...
%                 switch TrialTypes(currentTrial)
%                     case 1
%                         disp('set auto to short delay start')
%                         AutoPressVisDelay_s = S.GUI.PreVis2DelayShort_s;
%                     case 2
%                         disp('set auto to long delay start')
%                         AutoPressVisDelay_s = S.GUI.PreVis2DelayLong_s;
%                 end                
%             end
%         end
% 
%         % if previous trial rewarded, increment auto delay
%         if  (currentTrial>1 && ...      
%             S.GUI.EnableAutoDelay && ...
...
% 
% 
%         % update delay used for current trial
...
%         end    
        ...
        VisDetect1OutputAction = {'SoftCode', 5,'RotaryEncoder1', ['E']};
        ...
        VisDetect1_StateChangeConditions = {'Tup', 'VisStimInterruptDetect1', 'BNC1High', 'VisDetectGray1', 'RotaryEncoder1_2', 'EarlyPress1'};
        VisDetectGray1_StateChangeConditions = {'Tup', 'VisStimInterruptGray1', 'BNC1High', 'VisualStimulus1', 'RotaryEncoder1_2', 'EarlyPress1'};
        VisualStimulus1_StateChangeConditions = {'BNC1Low', 'WaitForPress1'};
        VisualStimulus1_OutputActions = [audStimOpto1, 'RotaryEncoder1', ['E']];       
        ...
        VisDetect2_StateChangeConditions = {'Tup', 'VisStimInterruptDetect2', 'BNC1High', 'VisDetectGray2', 'RotaryEncoder1_2', 'EarlyPress2'};
        VisDetectGray2_StateChangeConditions = {'Tup', 'VisStimInterruptGray2', 'BNC1High', 'VisualStimulus2', 'RotaryEncoder1_2', 'EarlyPress2'};
        ...
        sma = AddState(sma, 'Name', 'VisDetect1', ...
            ...
            'OutputActions', VisDetect1OutputAction);
        ...
        sma = AddState(sma, 'Name', 'VisDetect2', ...
            ...
            'OutputActions', VisDetect2OutputAction);  % ~50ms
