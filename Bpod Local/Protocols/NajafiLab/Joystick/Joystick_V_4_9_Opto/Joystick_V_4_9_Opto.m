...
try
    ...
    ExpNotes.ProtoVersion = 'Joystick_V_4_9_Opto'; % update to use current file name
    ...
    for currentTrial = 1:MaxTrials
        ...
        % if ~S.GUI.EnableRewardPulses
            ...
            sma = AddState(sma, 'Name', 'Press2', ...
                'Timer', Press2Window_s,...
                'StateChangeConditions', {'Tup', 'WaitForLatePress2', 'GlobalTimer11_End', 'WaitForLatePress2', 'RotaryEncoder1_1', 'PreRewardDelay'},...
