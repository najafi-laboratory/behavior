...
function [S] = SetParams(obj, BpodSystem)
    ...
    if isempty(fieldnames(S))  % If settings file was an empty struct, populate struct with default settings
        ...
        switch BpodSystem.Data.RigName
            case 'ImagingRig'
                S.GUI.ServoInPos = 1780.00; % lever start pos
                % S.GUI.ServoInPos = 1810.00; % lever start pos
                S.GUI.ServoOutPos = 34; % can press leverc
            case 'JoystickRig1'
                S.GUI.ServoInPos = 1517.00; % lever start pos
                S.GUI.ServoOutPos = 38; % can press lever
            % case 'JoystickRig2'
            case 'FPRig'
                S.GUI.ServoInPos = 1613.00; % lever start pos
                S.GUI.ServoOutPos = 38; % can press lever  
            case 'JoystickRig3'
        ...
        S.GUI.MinJitterRange = 2;
        S.GUI.MaxJitterRange = 5;
