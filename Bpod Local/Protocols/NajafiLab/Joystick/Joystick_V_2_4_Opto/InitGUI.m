...
function [S] = SetParams(obj, BpodSystem)
    ...
    if isempty(fieldnames(S))  % If settings file was an empty struct, populate struct with default settings
        ...
        S.GUI.CS_SquareFreq_Hz = 50;
        S.GUI.CS_SquareOnDur_ms = 5;
        S.GUI.PS_LEDOnPulseDur = 0.0078;
        S.GUI.PS_SquareFreq_s = 0.1;
        S.GUI.OptoVis1 = 1;
        ...
        S.GUIPanels.Opto = {'SessionType', 'PulseType', 'MaxOptoDur','CS_SquareFreq_Hz', 'CS_SquareOnDur_ms', 'PS_LEDOnPulseDur', 'PS_SquareFreq_s', 'OptoVis1', 'OptoWaitForPress1', 'OptoVis2', 'OptoWaitForPress2', 'OptoTrialTypeSeq', 'OnFraction', 'NumOptoTrialsPerBlock'};
