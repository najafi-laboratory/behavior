        ...
        function [sma] = InsertGlobalTimer(obj, BpodSystem, sma, S, VisStim)
            if obj.EnableOpto 
                ...
                switch S.GUI.PulseType
                    case 1
                        % LEDOnDur = VisStim.VisStimDuration - PMTCloseDelay;
                        LEDOffDur = 0;
                        ...
                        LEDOnDur = MinLoopIncrement;
                        LoopLED1 = floor(S.GUI.MaxOptoDur_s/LEDOnDur);

                        PMTCloseDur = MinLoopIncrement;
                        LoopPMT1 = floor((S.GUI.MaxOptoDur_s+PMTCloseDur)/PMTCloseDur);
                    ...
                    case 3
                        ...
                        % PMTOffDur = LEDOnDur + PMTOpenTransferDelay + 2*ScopeFrameDuration - PMTStartCloseDelay - ShutterPulseWidthAdd;
                        % PMTOffDur = LEDOnDur + PMTOpenTransferDelay + 2*ScopeFrameDuration - PMTStartCloseDelay - ShutterPulseWidthAdd;
