...
try
    ...
    TrialTypes = [];
    numTrialTypes = 2;
    [TrialTypes] =  m_TrialConfig.GenTrials(S, MaxTrials, numTrialTypes);
            ...
            case 2
                ...
                if S.GUI.VisStim2Enable
                    ...
                    if PressVisDelay_s == 0
                        ...
                        PreVis2Delay_StateChangeConditions = {'RotaryEncoder1_1', 'EarlyPress', 'Tup', 'VisDetect2'};
                    end                    
                else
