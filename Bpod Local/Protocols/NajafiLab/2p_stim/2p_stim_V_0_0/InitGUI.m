...
function [S] = SetParams(obj, BpodSystem)
    ...
    if isempty(fieldnames(S))
        ...
        S.GUI.OnFraction = 0;
        S.GUIPanels.Opto = {'OptoSession', 'OptoSource', 'TimeToFirstLaserPulse', 'LEDOnPulseDur', 'LEDOffPulseDur', 'OnFraction'};
        ...
        S.GUI.RightServoInPos = 1175;
        S.GUI.LeftServoInPos = 1680;
        ...
        S.GUIPanels.Contingency_Bias = {'ShortISIFraction', 'AdjustValve', 'NumMonitorTrials', 'BiasIndexThres', 'AdjustValvePercent', 'AdjustFraction'};
...
function [S] = UpdateOpto(obj, S, OnFraction)
    if (OnFraction >= 0)
        S.GUI.OnFraction = OnFraction;
    end
end
