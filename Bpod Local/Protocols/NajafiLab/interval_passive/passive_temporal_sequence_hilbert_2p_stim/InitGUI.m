...
function [S] = SetParams(obj, BpodSystem)
    ...
    if isempty(fieldnames(S))
        ...
        S.GUIPanels.Opto = {'OptoMode', 'OptoSource', 'TimeToFirstLaserPulse', 'OptoProb', 'OptoOnPreStim', 'OptoOffPostStim', 'OptoIntervalOdd', 'LEDOnPulseDur', 'LEDOffPulseDur', 'OptoAvoidFrameStart', 'OptoAvoidFrameBetween'};    
    end
end
