...
try
    ...
    for currentTrial = 1:MaxTrials
        ...
        sma = SetGlobalTimer(sma, 'TimerID', 1, 'Duration', OptoPulseDur, 'OnsetDelay', 0,...
            'Channel', 'BNC2', 'OnLevel', 1, 'OffLevel', 0,...
            'Loop', 1, 'SendGlobalTimerEvents', 0, 'LoopInterval', IPI,...
        ...
        sma = AddState(sma, 'Name', 'Start', ...
            'Timer', 0,...
            'StateChangeConditions', {'Tup', 'OptoPulse'},...
