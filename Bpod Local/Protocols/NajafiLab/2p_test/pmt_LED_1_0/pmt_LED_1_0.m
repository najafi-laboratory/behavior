...
try
    ...
    for currentTrial = 1:MaxTrials
        ...
        sma = AddState(sma, 'Name', 'FrameDetect1', ...
            'Timer', 0.5,...
            'StateChangeConditions', {'Tup', 'Frame1', 'BNC1High', 'Frame1'},...
            'OutputActions', {'BNC1', 1}); %        

        sma = AddState(sma, 'Name', 'Frame1', ...
            'Timer', 0.5,...
            'StateChangeConditions', {'Tup', 'FrameDetect2', 'BNC1Low', 'FrameDetect2'},...
            'OutputActions', {}); %       
        ...
        sma = AddState(sma, 'Name', 'FrameDetect2', ...
            'Timer', 0.5,...
            'StateChangeConditions', {'Tup', 'Frame2', 'BNC1High', 'Frame2'},...
            'OutputActions', {'BNC1', 1}); %       

        sma = AddState(sma, 'Name', 'Frame2', ...
            'Timer', 0.5,...
            'StateChangeConditions', {'Tup', 'FrameDetect3', 'BNC1Low', 'FrameDetect3'},...
            'OutputActions', {}); % 
        ...
        sma = AddState(sma, 'Name', 'FrameDetect3', ...
            'Timer', 0.5,...
            'StateChangeConditions', {'Tup', 'Frame3', 'BNC1High', 'Frame3'},...
            'OutputActions', {'BNC1', 1}); %      
