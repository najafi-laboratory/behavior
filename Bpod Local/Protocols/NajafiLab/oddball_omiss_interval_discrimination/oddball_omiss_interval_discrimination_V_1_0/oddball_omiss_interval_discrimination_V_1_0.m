function oddball_omiss_interval_discrimination_V_1_0
try
    ...
    protocol_version = 'oddball_omiss_interval_discrimination_V_1_0';
    ...
    for currentTrial = 1:S.GUI.MaxTrials
        ...
        [ChangePoint] = m_TrialConfig.GetChangePoint(S);
        BpodSystem.Data.TrialVars.Trial{currentTrial}.ChangePoint = ChangePoint;
        ...
        VisStim = m_AVstimConfig.GetVideoDataPost(S, BpodSystem, FPS, VisStim, GrayPerturbISI, JitterFlag, ChangePoint, OddballISI);
