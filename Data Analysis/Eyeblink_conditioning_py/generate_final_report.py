...
REPORT_FIGURES = [
    ...
    "fig2.pdf",
    "fig3.pdf",
    "fig4_pooled_avg_with_probe.pdf",
    "fig5_pooled_avg_with_probe.pdf",
    "fig6.pdf",
    "fig7.pdf",
    "fig8.pdf",
    "fig9.pdf",
...
def build_composites() -> None:
    ...
    build_composite_pdf(
        "fig4_pooled_avg_with_probe.pdf",
        "fig4_pooled_avg_with_probe.png",
        [ROOT / "fig4.pdf", ROOT / "Probe_03_FEC_Triplets_Raw.pdf"],
    )
    build_composite_pdf(
        "fig5_pooled_avg_with_probe.pdf",
        "fig5_pooled_avg_with_probe.png",
        [ROOT / "fig5.pdf", ROOT / "Probe_03_FEC_Triplets_BaselineMatched.pdf"],
    )
    build_composite_pdf(
        "fig16_trial_adaptation_raw_3row.pdf",
    ...
    return [
        Section(
            ...
            (
                ...
                Subhead("FEC Traces"),
                Subhead("Pooled Avg"),
                FigureCard("fig4", "Figure 4 - Pooled Avg raw", "fig4_pooled_avg_with_probe.pdf", "fig_report_assets/fig4_pooled_avg_with_probe.png", "Figure 4 pooled average raw preview", ("tall",)),
                FigureCard("fig5", "Figure 5 - Pooled Avg baseline-matched", "fig5_pooled_avg_with_probe.pdf", "fig_report_assets/fig5_pooled_avg_with_probe.png", "Figure 5 pooled average baseline-matched preview", ("tall",)),
            ),
        ),
        Section(
            "Grand Avg",
        ...
        Section(
            ...
            (
                FigureCard("fig14", "Figure 14", "fig14.pdf", "fig_report_assets/fig14.png", "Figure 14 preview", ("compact-centered",)),
