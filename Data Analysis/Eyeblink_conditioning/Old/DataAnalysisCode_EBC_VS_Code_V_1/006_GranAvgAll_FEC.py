...
def main():
    ...
    if len(data_files) == 0:
        print(f"No *_EBC_*.mat files found in {script_dir}.  GranAvgAll_FEC.py:283 - 006_GranAvgAll_FEC.py:348")
        return
    ...
    for filepath in data_files:
        print(f"Processing: {filepath}  GranAvgAll_FEC.py:335 - 006_GranAvgAll_FEC.py:396")
    ...
    print(f"Baseline-matched (session means): "
    ...
    print(f"Saved figure to: {outname}  GranAvgAll_FEC.py:472 - 006_GranAvgAll_FEC.py:525")
