...
title_text(1) = {' '};
title_text(2) = {'CR$^{+}$ short-block trials above the baseline+CR$_{\rm{th}}$ in $(T_{\rm{AirPuff - 0.05(s)}},T_{\rm{AirPuff}})$'};
...
title_text_long(1) = {'CR$^{+}$ long-block trials above the baseline+CR$_{\rm{th}}$ in $(T_{\rm{AirPuff - 0.05(s)}},T_{\rm{AirPuff}})$'};
