...
data_files = dir('SA13_EBC_Opto_V_5_3_20260123_154305_ID761660.mat');
...
plot_index = 0; % Counts only successful plots
...
for ctr_trial = 1:numTrials
        ...
        plot_index = plot_index + 1;  % Only increment if trial is valid for plotting
...
ctr_row = mod(ceil(plot_index/n_column)-1, n_row);
ctr_column = mod(plot_index-1, n_column);
...
remainingTrials = mod(plot_index, 20);
if remainingTrials > 0
