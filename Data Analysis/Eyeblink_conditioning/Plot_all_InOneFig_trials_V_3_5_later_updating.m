...
xline(0, '--r'); % zero aligned to LED Onset

AirPuff_start_LED_Onset_Aligned = SessionData.RawEvents.Trial{1, 1}.Events.GlobalTimer2_Start - LED_start_time;
AirPuff_stop_LED_Onset_Aligned = SessionData.RawEvents.Trial{1, 1}.Events.GlobalTimer2_End - LED_start_time;
