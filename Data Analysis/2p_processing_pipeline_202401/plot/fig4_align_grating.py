...
def read_data(
    ...
    return [neural_trials, label, dff, vol_img_bin, vol_stim_bin, vol_time]
...
def plot_fig4(
    ...
    try:
        ...
        fig.set_size_inches(4, num_subplots*4)
        fig.tight_layout()
