# -*- coding: utf-8 -*-
"""
Created on Mon May  5 12:58:28 2025
    ...
    for i in range(len(outcomes)):
        ...
        for j in range(len(outcome)):
            if outcome[j] == 'Reward':
                ...
                if opto_tag[j] == 1:
                    label[i][j] = 'Opto_EarlyPress2'
                else:
                    label[i][j] = 'Control_EarlyPress2'
            elif outcome[j] == 'LatePress2':
                if opto_tag[j] == 1:
                    label[i][j] = 'Opto_LatePress2'
                else:
                    label[i][j] = 'Control_LatePress2'
            else:
                'Control_Rest'
    return label
...
def run_opto_delay(axs, session_data, delay_data, press_type, color_tag = 'k'):
    ...
    all_labels = ['Opto_Reward' , 'Control_Reward' ,'Opto_EarlyPress2' , 'Control_EarlyPress2','Opto_LatePress2' , 'Control_LatePress2']
