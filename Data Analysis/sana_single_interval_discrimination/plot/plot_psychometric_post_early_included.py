...
def get_decision(subject_session_data):
    ...
    post_isi = subject_session_data['post_isi_early_included']
...
def run(ax, subject_session_data):
    ...
    ax.plot(
        bin_isi_jitter,
        bin_mean_jitter,
        color='red', marker='.', label='jitter', markersize=4)
    ax.fill_between(
        bin_isi_jitter,
    ...
    ax.set_title('average psychometric function (included early licking)')
