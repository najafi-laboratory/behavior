...
class SingleIntervalDiscriminationAnalyzer:
    """
    Experiment-specific analyzer for single interval discrimination data.
    ...
    def __init__(self, config_manager, subject_list, loaded_data, logger):
        ...
        self.logger.info("DA-SID: Initializing SingleIntervalDiscriminationAnalyzer...")
        ...
        self.logger.info("DA-SID: SingleIntervalDiscriminationAnalyzer initialized successfully")
    
    def analyze_data(self) -> Dict[str, Any]:
        """
        Perform single interval discrimination specific analysis.
        
        Returns:
            Analysis results dictionary
        """
        self.logger.info("DA-SID: Starting single interval discrimination analysis...")
        
        analysis_results = {
            'analysis_type': 'single_interval_discrimination',
        ...
        self.logger.info("DA-SID: Single interval discrimination analysis completed")
        return analysis_results
    
    def _analyze_subject(self, subject_id: str, subject_data: Dict[str, Any]) -> Dict[str, Any]:
        """Analyze data for a single subject."""
        self.logger.info(f"DA-SID: Analyzing subject {subject_id}")
    ...
    def _compute_isi_pdf(self, df_trials: pd.DataFrame) -> Dict[str, Any]:
        ...
        try:
            ...
            if 'isi' not in df_trials.columns:
                self.logger.warning("DA-SID: No 'isi' column found in trial data")
            ...
            self.logger.error(f"DA-SID: Failed to compute ISI PDF: {e}")
    ...
    def _analyze_group(self) -> Dict[str, Any]:
        ...
        self.logger.info("DA-SID: Performing group analysis...")
