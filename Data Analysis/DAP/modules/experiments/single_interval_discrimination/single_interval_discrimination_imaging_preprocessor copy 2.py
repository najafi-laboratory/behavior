...
class SingleIntervalDiscriminationImagingPreprocessor:
    ...
    def load_dff_traces(self, output_path: str, subject_id: str, voltage_data: Dict[str, Any], use_memmap: bool = True) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            dff_data['fs'] = n_frames / (imaging_time_array[-1] - imaging_time_array[0])  # Recalculate fs based on timing
    ...
    def load_voltage_data(self, output_path: str, subject_id: str, use_memmap: bool = True) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            with h5py.File(voltage_file, 'r') as f:
                ...
                voltage_data['voltage_fs'] = 1000.0
    ...
    def segments_to_arrays(self, trial_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            self.logger.error(f"SID_IMG: Failed to convert segments to arrays: {e}")
            return {'error': str(e)}
    ...
    def ensure_dataframe_format(self, trial_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if 'df_trials_with_segments' in trial_data:
            ...
            self.logger.error("SID_IMG: Cannot convert array format back to DataFrame format")
    ...
    def analyze_roi_responsiveness(self, imaging_data: Dict[str, Any], trial_data: Dict[str, Any], subject_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            self.logger.info(f"SID_IMG: Statistical thresholds - p_value: {analysis_params['statistical_thresholds']['p_value']}, "
            ...
            for event_name in analysis_params['alignment_events']:
                self.logger.info(f"SID_IMG: Analyzing responsiveness to {event_name}")
                ...
                if 'error' in event_trial_data:
                    self.logger.warning(f"SID_IMG: Skipping {event_name} - {event_trial_data['error']}")
                    continue
            ...
            self.logger.error(f"SID_IMG: Failed to analyze ROI responsiveness: {e}")
            return {'error': str(e)}
    ...
    def _analyze_event_filter_responsiveness(self, event_trial_data: Dict[str, Any], 
        ...
        try:
            ...
            self.logger.error(f"SID_IMG: Error in _analyze_event_filter_responsiveness: {e}")
    ...
    def _test_roi_responsiveness(self, filtered_trials: pd.DataFrame, roi_idx: int,
        ...
        try:
            ...
            self.logger.error(f"SID_IMG: Error in _test_roi_responsiveness: {e}")
            return {'error': str(e)}
    ...
    def _calculate_trial_reliability(self, trial_traces: List[np.ndarray], response_mask: np.ndarray) -> float:
        ...
        try:
            ...
            self.logger.debug(f"SID_IMG: Error in trial reliability calculation: {e}")
            return np.nan
    ...
    def _calculate_trial_reliability_fast(self, trial_traces: List[np.ndarray], response_mask: np.ndarray) -> float:
        ...
        try:
            ...
            self.logger.debug(f"SID_IMG: Error in fast trial reliability calculation: {e}")
            return np.nan
    ...
    def _compute_roi_basic_properties(self, responsiveness_data: Dict, imaging_data: Dict[str, Any]) -> None:
        ...
        try:
            ...
            self.logger.error(f"SID_IMG: Error computing basic properties: {e}")
    ...
    def _compute_roi_reliability_metrics(self, responsiveness_data: Dict) -> None:
        ...
        try:
            ...
            self.logger.error(f"SID_IMG: Error computing reliability metrics: {e}")
    ...
    def _compute_cross_event_patterns(self, responsiveness_data: Dict, analysis_params: Dict) -> None:
        ...
        try:
            ...
            self.logger.error(f"SID_IMG: Error in _compute_cross_event_patterns: {e}")
    ...
    def _compute_summary_statistics(self, responsiveness_data: Dict, n_rois: int) -> None:
        ...
        try:
            ...
            self.logger.error(f"SID_IMG: Error in _compute_summary_statistics: {e}")
    ...
    def save_responsiveness_data(self, responsiveness_data: Dict[str, Any], output_path: str) -> None:
        ...
        try:
            ...
            self.logger.info(f"SID_IMG: Saved ROI responsiveness data to {responsiveness_file}")
            
        except Exception as e:
            self.logger.error(f"SID_IMG: Failed to save responsiveness data: {e}")
    ...
    def load_responsiveness_data(self, output_path: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            self.logger.info(f"SID_IMG: Loaded ROI responsiveness data from {responsiveness_file}")
            return responsiveness_data
            
        except Exception as e:
            self.logger.error(f"SID_IMG: Failed to load responsiveness data: {e}")
            return None
    ...
    def _plot_responsiveness_heatmap(self, responsiveness_data: Dict[str, Any], subject_id: str) -> None:
        ...
        try:
            ...
            self.logger.error(f"SID_IMG: Failed to create responsiveness heatmap: {e}")
    ...
    def _plot_response_type_distributions(self, responsiveness_data: Dict[str, Any], subject_id: str) -> None:
        ...
        try:
            ...
            self.logger.error(f"SID_IMG: Failed to create response type distributions: {e}")
    ...
    def _plot_roi_classification(self, responsiveness_data: Dict[str, Any], subject_id: str) -> None:
        ...
        try:
            ...
            if len(responsive_roi_indices) < 2:
                self.logger.warning("SID_IMG: Too few responsive ROIs for clustering analysis")
                return
            ...
            if len(responsive_roi_indices) > max_rois_for_clustering:
                ...
                self.logger.info(f"SID_IMG: Clustering top {max_rois_for_clustering} most responsive ROIs out of {len(responsive_roi_indices)} total")
            else:
                top_roi_global_indices = responsive_roi_indices
                self.logger.info(f"SID_IMG: Clustering all {len(responsive_roi_indices)} responsive ROIs")
            ...
            if np.any(informative_features):
                ...
                self.logger.warning("SID_IMG: No informative features for clustering")
                
        except Exception as e:
            self.logger.error(f"SID_IMG: Failed to create ROI classification: {e}")
    ...
    def _plot_roi_classification_summary(self, responsiveness_data: Dict[str, Any], subject_id: str) -> None:
        ...
        try:
            ...
            self.logger.info(f"SID_IMG: ROI Classification Summary:")
            ...
            self.logger.error(f"SID_IMG: Failed to create ROI classification summary: {e}")
    ...
    def _plot_event_selectivity(self, responsiveness_data: Dict[str, Any], subject_id: str) -> None:
        ...
        try:
            ...
            if not roi_selectivity:
                self.logger.warning("SID_IMG: No responsive ROIs found for selectivity analysis")
                return
            ...
            self.logger.info(f"SID_IMG: Selectivity analysis - {len(roi_selectivity)} responsive ROIs")
            self.logger.info(f"SID_IMG: High selectivity ROIs (entropy < 1.0): {len(high_selectivity_rois)}")
            self.logger.info(f"SID_IMG: Broadly responsive ROIs: {len(broad_response_rois)}")
            
        except Exception as e:
            self.logger.error(f"SID_IMG: Failed to create event selectivity plots: {e}")
    ...
    def plot_responsiveness_summary(self, responsiveness_data: Dict[str, Any], 
        ...
        try:
            ...
            self.logger.error(f"SID_IMG: Failed to create responsiveness summary plots: {e}")
    ...
    def plot_all_rois_heatmap_by_responsiveness(self, trial_data: Dict[str, Any], 
        ...
        try:
            ...
            if 'error' in responsiveness_data:
                self.logger.error(f"SID_IMG: Cannot plot - responsiveness analysis failed: {responsiveness_data['error']}")
                return
            ...
            if 'df_trials_with_segments' in trial_data:
                ...
                self.logger.error("SID_IMG: This function requires DataFrame format trial data")
                return
            ...
            # Log summary
            n_trials = len(selected_trials)
            self.logger.info(f"SID_IMG: Responsiveness-sorted heatmap - {n_trials} trials, {n_rois} ROIs")
            self.logger.info(f"SID_IMG: {len(responsive_rois)} responsive, {len(non_responsive_rois)} non-responsive")
            self.logger.info(f"SID_IMG: Sort criteria: {event_filter}|{trial_filter}|{response_type_filter}|{sort_method}")
            
            if responsive_rois:
                top_roi_idx = sorted_metrics[0][0]
                top_metric = sorted_metrics[0][1]
                self.logger.info(f"SID_IMG: Most responsive ROI: {top_roi_idx} ({sort_method}: {top_metric:.3f})")
            
        except Exception as e:
            self.logger.error(f"SID_IMG: Failed to create responsiveness-sorted ROI heatmap: {e}")
    ...
    def correct_trial_timestamps_with_voltage_pulses(self, df_trials: pd.DataFrame, imaging_data: Dict[str, Any]) -> pd.DataFrame:
        ...
        try:
            ...
            self.logger.error(f"SID_IMG: Failed to correct trial timestamps: {e}")
    ...
    def explore_roi_responsiveness_patterns(self, trial_data: Dict[str, Any], 
        ...
        try:
            if 'error' in trial_data or 'error' in responsiveness_data:
                self.logger.error("SID_IMG: Cannot explore patterns - data extraction failed")
                return
            ...
            self.logger.info(f"SID_IMG: Starting comprehensive responsiveness pattern exploration for {subject_id}")
            self.logger.info(f"SID_IMG: Testing {len(events)} events × {len(trial_filters)} filters × {len(response_types)} response types × {len(trial_types)} trial types × {len(sort_methods)} sort methods")
            ...
            self.logger.info(f"SID_IMG: Found {len(base_combinations)} valid base combinations (≥5 responsive ROIs)")
            
            # Create summary table of top base combinations
            self.logger.info("SID_IMG: Top 10 most responsive base combinations:")
            ...
            self.logger.info(f"SID_IMG: Plotting top {len(combinations_to_plot)} combinations with all sort methods")
            
            plot_count = 0
            for combo_idx, base_combo in enumerate(combinations_to_plot):
                combo_number = combo_idx + 1
                self.logger.info(f"SID_IMG: Combination {combo_number}: {base_combo['event']} | {base_combo['trial_filter']} | {base_combo['response_type']} | {base_combo['trial_type']} ({base_combo['responsive_count']} ROIs)")
            ...
            self.logger.error(f"SID_IMG: Failed to explore responsiveness patterns: {e}")
    ...
    def _generate_exploration_summary(self, combinations: List[Dict], subject_id: str) -> None:
        ...
        try:
            ...
            self.logger.info(f"SID_IMG: Exploration Summary for {subject_id}:")
            ...
            self.logger.error(f"SID_IMG: Failed to generate exploration summary: {e}")
    ...
    def process_subject(self, subject_id: str, suite2p_path: str, output_path: str, force: bool = False) -> Dict[str, Any]:
            ...
            try:
                ...
                imaging_data_file = os.path.join(output_path, 'imaging_preprocess_data.pkl')
                behavioral_data_file = os.path.join(output_path, 'behavioral_preprocess_data.pkl')
                responsiveness_data_file = os.path.join(output_path, 'roi_responsiveness.json')
                
                imaging_behavioral_force = False
                responsiveness_force = True
                ...
                if (os.path.exists(results_file) and 
                    ...
                    self.logger.info(f"SID_IMG: SID imaging data already exists for {subject_id}, loading existing data")
                    ...
                    try:
                        ...
                        self.logger.info(f"SID_IMG: Successfully loaded existing data for {subject_id}")
                        
                    except Exception as e:
                        self.logger.warning(f"SID_IMG: Failed to load existing data, reprocessing: {e}")
                        # If loading fails, continue with normal processing
                        imaging_data = None
                ...
                # Only do data loading if we don't have existing data
                if imaging_data is None or behavioral_data is None:
                    ...
                    try:
                        ...
                        self.logger.info(f"SID_IMG: Saved imaging and behavioral data for {subject_id}")
                        
                    except Exception as e:
                        self.logger.warning(f"SID_IMG: Failed to save data files: {e}")


                # SEPARATE: Check for responsiveness data (compute-heavy, optional)
                responsiveness_data = None
                if os.path.exists(responsiveness_data_file) and not responsiveness_force:
                    self.logger.info(f"SID_IMG: Loading existing responsiveness data for {subject_id}")
                    responsiveness_data = self.load_responsiveness_data(output_path)
                    
                    if responsiveness_data is not None:
                        self.logger.info(f"SID_IMG: Successfully loaded existing responsiveness data for {subject_id}")
                    else:
                        self.logger.warning(f"SID_IMG: Failed to load responsiveness data, will skip or recompute if needed")
                else:
                    self.logger.info(f"SID_IMG: No existing responsiveness data found for {subject_id}")

                # Comprehensive ROI responsiveness analysis (OPTIONAL - only if you want it)
                run_responsiveness_analysis = True  # Set this to False to skip during dev
                
                if run_responsiveness_analysis and responsiveness_data is None:
                    self.logger.info(f"SID_IMG: Starting comprehensive ROI responsiveness analysis for {subject_id}")                
                    responsiveness_data = self.analyze_roi_responsiveness(imaging_data, behavioral_data['df_trials'], subject_id)
                    
                    if 'error' not in responsiveness_data:
                        # Save responsiveness data
                        self.save_responsiveness_data(responsiveness_data, output_path)
                        self.logger.info(f"SID_IMG: ROI responsiveness analysis completed for {subject_id}")
                    else:
                        self.logger.error(f"SID_IMG: ROI responsiveness analysis failed: {responsiveness_data['error']}")
                elif responsiveness_data is None:
                    self.logger.info(f"SID_IMG: Skipping responsiveness analysis for {subject_id} (set run_responsiveness_analysis=True to enable)")                


                # Create plots if responsiveness data exists
                if responsiveness_data is not None and 'error' not in responsiveness_data:
                    # Create responsiveness summary plots
                    self.plot_responsiveness_summary(responsiveness_data, subject_id, output_path)
                    
                    # Advanced analyses
                    self.plot_roi_functional_connectivity(responsiveness_data, imaging_data, subject_id)
                    self.plot_roi_response_profiles(responsiveness_data, subject_id)
                    self.plot_population_dynamics(responsiveness_data, behavioral_data['df_trials'], subject_id)
                    self.plot_population_vector_analysis(behavioral_data['df_trials'], responsiveness_data, subject_id)                    
                    
                    # Update imaging_data with responsiveness labels
                    imaging_data['roi_responsiveness'] = responsiveness_data
                ...
                self.explore_roi_responsiveness_patterns(trial_data, responsiveness_data, 'start_flash_1', subject_id)

                # Sort by effect size for start_flash_1 activation in left trials
                self.plot_all_rois_heatmap_by_responsiveness(
                    trial_data, responsiveness_data, subject_id,
                    event_filter='start_flash_1', 
                    trial_filter='left', 
                    response_type_filter='activation',
                    sort_method='effect_size',
                    trial_type='all'
                )
                ...
                # # Sort by response timing for choice_start responses in right trials
                # self.plot_all_rois_heatmap_by_responsiveness(
                #     trial_data, responsiveness_data, subject_id,
                #     event_filter='choice_start', 
                #     trial_filter='right', 
                #     response_type_filter='activation',
                #     sort_method='response_timing',
                #     trial_type='rewarded'
                # )

                # # Sort by reliability for suppression responses
                # self.plot_all_rois_heatmap_by_responsiveness(
                #     trial_data, responsiveness_data, subject_id,
                #     event_filter='start_flash_1', 
                #     trial_filter='left', 
                #     response_type_filter='suppression',
                #     sort_method='reliability',
                #     trial_type='all'
                # )
                ...
                # Comprehensive parameter exploration
                self.explore_roi_responsiveness_patterns(trial_data, responsiveness_data, 'choice_start', subject_id)
