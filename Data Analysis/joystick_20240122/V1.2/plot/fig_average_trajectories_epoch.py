...
def average_superimposed_epoch(
        session_data,
        output_dir_onedrive, 
        output_dir_local
        ):
    ...
    fig.suptitle(subject + '\n Average Trajectories superimposed for Rewarded Trials\n')
    # ALL TRIALS
    ...
    for i in range(0 , len(session_id)):
        ...
        for trial in range(Block_size ,len(TrialOutcomes)):
            ...
            if TrialOutcomes[trial] == 'Reward':
                ...
                # trial_rew.append(trial)
                # onset1.append(on1_vel)
                # onset2.append(on2_vel)    
    ...
    pdf_path = os.path.join(output_figs_dir, subject + '_Learning_Epoch_Superimposed_average_trajectories.pdf')
    ...
    # # Assuming onset1, onset2, and rew_trial are numpy arrays
    # np.savez('arrays.npz', onset1=onset1, onset2=onset2, trial_rew=trial_rew)              
