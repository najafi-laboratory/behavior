...
if __name__ == '__main__':
    # --- 1. SLURM SETUP ---
    # Get the task ID from SLURM (default to 0 for testing on your laptop)
    ...
    if len(DATA_PATHS) == 0:
        ...
        bounds = [
            ...
            (0.01, 0.45),    # 10: p_rare
            (0.0, 0.2)       # 11: alpha_boundary (0.0 to 0.2 step size usually sufficient)
        ]

        # Use CPU count for multiprocessing
        ...
        # Main Progress Bar for Sessions
        ...
        if sessions_df:
            ...
            # --- NEW: SAVE EVERYTHING ---
            save_comprehensive_results(results, prefix='Dynamic_Boundary_Fit', save_path=SAVE_PATH)