...
def read_trials(subject, file_names):
    ...
    for f in range(len(file_names)):
        ...
        # for i in range(0, 100):
            ...
            if not np.isnan(trial_states['VisualStimulus2'][0]):
                ...
                HasVis2 = 1
                trial_wait_2_aligned.append(i)
                print('trial_wait_2_aligned', i)
            else:
                HasVis2 = 0
        ...
        sess_short_pun_rate = 0
        
        sess_long_hit_rate = 0
        sess_long_pun_rate = 0
        ...
        if not isSelfTimedMode:
            ...
            sess_short_num_rew = 0
            sess_short_num_pun = 0
            sess_long_num_rew = 0
            sess_long_num_pun = 0
        ...
        session_wait_2_aligned.append(trial_wait_2_aligned)
    ...
    data = {
        ...
        'session_wait_2_aligned' : session_wait_2_aligned,
        'com' : session_com,
