            ...
            if trial_type[i] == 1:
                ...
                if outcome[i] == 'Reward':
                    ...
                    if 'Port1In' in trial_events:
                        ...
                        process_lick_data(
                            ...
                            short_ISI_reward_left_correct_lick, trial_ISI[i], opto_tag[i]
                        )
                    ...
                    if 'Port3In' in trial_events:
                        process_lick_data(
                            ...
                            short_ISI_reward_right_incorrect_lick, trial_ISI[i], opto_tag[i]
                        )
                ...
                # Incorrect right lick (punished)
                    ...
                    if 'Port3In' in trial_events:
                        ...
                        process_lick_data(
                            trial_events, trial_states, choice_window_start, 'Port3In', 'Port3Out',
                            short_ISI_punish_right_incorrect_lick, trial_ISI[i], opto_tag[i]
                        )
                    ...
                    if 'Port1In' in trial_events:
                        process_lick_data(
                            trial_events, trial_states, choice_window_start, 'Port1In', 'Port1Out',
                            short_ISI_punish_left_correct_lick, trial_ISI[i], opto_tag[i]
                        )
            ...
            # Long ISI trials
                ...
                if outcome[i] == 'Reward':
                    ...
                    if 'Port3In' in trial_events:
                        ...
                        process_lick_data(
                            trial_events, trial_states, choice_window_start, 'Port3In', 'Port3Out',
                            long_ISI_reward_right_correct_lick, trial_ISI[i], opto_tag[i]
                        )
                    ...
                    if 'Port1In' in trial_events:
                        process_lick_data(
                            trial_events, trial_states, choice_window_start, 'Port1In', 'Port1Out',
                            long_ISI_reward_left_incorrect_lick, trial_ISI[i], opto_tag[i]
                        )
                ...
                # Incorrect left lick (punished)
                    ...
                    if 'Port1In' in trial_events:
                        ...
                        process_lick_data(
                            trial_events, trial_states, choice_window_start, 'Port1In', 'Port1Out',
                            long_ISI_punish_left_incorrect_lick, trial_ISI[i], opto_tag[i]
                        )
                    ...
                    if 'Port3In' in trial_events:
                        process_lick_data(
                            trial_events, trial_states, choice_window_start, 'Port3In', 'Port3Out',
                            long_ISI_punish_right_correct_lick, trial_ISI[i], opto_tag[i]
                        )
        # reverse ###########################################################################################
...
def process_lick_data(trial_events, trial_states, choice_window_start, port_in, port_out, data_dict, trial_isi, opto_tag):
    """
