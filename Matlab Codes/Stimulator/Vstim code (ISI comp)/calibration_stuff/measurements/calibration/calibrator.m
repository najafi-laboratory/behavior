...
fid = fopen('spectrum_red_CRT','w');   %now measure spectrum
...
fid = fopen('spectrum_green_CRT','w');   %now measure spectrum
...
fid = fopen('spectrum_blue_CRT','w');   %now measure spectrum
